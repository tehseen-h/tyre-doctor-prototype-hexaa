...
// Ported from project/src/config/rules.js. Do not change values without updating
// the source string — the presenter defends every number on the call from this file.
...
export const categoryFor = (mm: number, beltPly: boolean, position?: string): 'Minor' | 'Intermediate' | 'Major' => {
